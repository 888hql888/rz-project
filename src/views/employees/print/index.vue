    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          <el-button v-print="{id:'printDom'}" size="small" type="primary"
            >打印</el-button
          >
        </el-row>
        <div id="printDom">
...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      const res = await getPersonalDetail(this.userId); // 获取个人基本信息
      this.formData = res.data;
    },
    async getJobDetail() {
      const res = await getUserDetailById(this.userId);
      const userInfo = res.data;
      const res2 = await getJobDetail(this.userId); // 获取个人基本信息
      const jobInfo = res2.data; // 获取个人基本信息
